...
class ShoppingCart {
    ...
    addItem(productId, quantity = 1) {
        ...
        try {
            ...
            product.stock -= quantity; //stock güncelleme eklendi
    ...
    removeItem(productId) {
        try {
            ...
            if (product) {
                product.stock += item.quantity; // item.quantity yerine sabit değer değiştirildi
            }
    ...
    calculateTotal() {
        this.total = this.items.reduce((sum, item, quantity) => {
